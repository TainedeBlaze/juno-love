export default function Mixes() {
  ...
  return (
    <section id="mixes" className="px-6 py-20 lg:px-10 lg:py-32">
      <div className="mx-auto max-w-6xl">
        ...
        <div className="mb-12 lg:mb-16">
          ...
          <div className="flex flex-col gap-6 sm:flex-row sm:items-end sm:justify-between">
            <div>
              <h2 className="mb-4 font-title text-4xl uppercase tracking-tight text-white lg:text-5xl">
                Recent Mixes
              </h2>
            ...
            <a
              ...
              className="flex shrink-0 items-center gap-2 border border-white/30 px-4 py-2 text-sm uppercase tracking-wider text-white/60 transition-colors hover:border-white hover:text-white"
            >
        ...
        <div className="grid gap-8 lg:grid-cols-2">
          {mixes.map((mix) => (
            <div key={mix.title}>
              ...
              <h3 className="mb-4 text-base uppercase tracking-wider text-white lg:text-lg">
                {mix.title}
              </h3>
